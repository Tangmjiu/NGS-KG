...
/// 播放扩展面板：倍速 / 音质 / 音效 / 定时关闭 / 下载。
///
/// 移动端以 M3 Dialog 形式打开，聚合原本分散在各独立页面的设置。
  ...
  static Future<void> show(BuildContext context) {
    return showM3Dialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const SingleChildScrollView(child: PlayerExtrasPanel()),
        actions: [
          TextButton(
      ...
      children: [
        ...
        for (final key in Quality.levels)
          _RadioTile(
            ...
            badge: p.isQualityAvailable(key) && !availableQualities.contains(key)
                ? '降级可用'
                : null,
