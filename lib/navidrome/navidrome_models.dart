...
int? _toInt(dynamic value) {
  ...
  if (value is String) {
    // Subsonic returns "<null>" as a literal string for null values
...
class SubsonicAlbum {
  ...
  /// Raw created timestamp (milliseconds since epoch).
  /// Subsonic returns seconds since epoch; multiply by 1000 if needed.
  final int created;
